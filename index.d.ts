declare module "react-native-map-direction-with-custom-url" {
  // Type definitions for react-native-map-direction-with-custom-url 2.0
  // Project: https://github.com/dhruv-nagvadia/react-native-map-direction-with-custom-url
  // Based on original work by: Ali Oguzhan Yildiz <https://github.com/alioguzhan>
  // Based on original work by: Chris Shaffer (methodbox)<https://github.com/methodbox>
  ...
  export interface MapViewDirectionsProps {
    ...
    /**
     * Your Google Maps API Key. Required when useBackendApi is false (default).
     */
    apikey?: string;
    /**
     * Set to true to route requests through your own backend instead of calling Google Maps directly.
     * Useful when your Google Maps key has bundle ID / package name restrictions.
     * Default: false
     */
    useBackendApi?: boolean;
    /**
     * Your backend endpoint URL. Required when useBackendApi is true.
     * Your backend must return the Google Maps Directions API format: { status: 'OK', routes: [...] }
     */
    backendUrl?: string;
    /**
     * Optional Bearer token sent in the Authorization header to authenticate with your backend.
     */
